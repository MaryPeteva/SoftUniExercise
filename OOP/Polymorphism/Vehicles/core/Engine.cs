...
public class Engine : IEngine
{
    ...
    private readonly IVehFactory vehicleFactory;

    private readonly ICollection<IVehicle> vehicles;

    public Engine(IReader reader, IWriter writer, IVehFactory vehicleFactory)
    {
        this.reader = reader;
        this.writer = writer;
