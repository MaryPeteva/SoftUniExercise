...
public class Test_001_001_002
{
    ...
    {
        CurrentType = GetType("Performer");

        AssertPropertyIsOfType("Id", typeof(int));
        AssertPropertyIsOfType("FirstName", typeof(string));
        AssertPropertyIsOfType("LastName", typeof(string));
        AssertPropertyIsOfType("Age", typeof(int));
        AssertPropertyIsOfType("NetWorth", typeof(decimal));
        AssertCollectionIsOfType("PerformerSongs", GetCollectionType(GetType("SongPerformer")));
    }
